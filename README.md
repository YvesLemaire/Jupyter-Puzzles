...
Un autre algorithme (D. L. Greenwell) est proposé pour le mastermind classique ($p=4$ positions et $n=6$ couleurs) qui consise à proposer 6 motifs, toujours les mêmes, pour calculer le code.
